...
export const CONFLICT_ZONES: ConflictZone[] = [
  ...
  },
  {
    id: 'venezuela',
    name: '委内瑞拉危机',
    coords: [[-73.4, 11.8], [-72.0, 11.5], [-71.0, 10.5], [-70.2, 9.0], [-69.5, 7.5], [-68.0, 6.0], [-67.5, 4.5], [-67.0, 3.0], [-66.5, 1.5], [-65.0, 1.0], [-63.5, 1.5], [-62.0, 3.0], [-61.0, 4.5], [-60.0, 5.5], [-59.8, 8.0], [-60.0, 10.0], [-61.5, 11.5], [-63.0, 12.0], [-66.0, 12.2], [-73.4, 11.8]],
    center: [-66, 8],
    intensity: 'high',
    parties: ['委内瑞拉政府', '反对派', '美国制裁'],
    casualties: '持续的政治暴力与经济崩溃',
    displaced: '760万+ 难民外逃',
    keywords: ['venezuela', 'caracas', 'maduro', 'guaido', 'sanctions', 'migration', 'humanitarian', 'oil'],
    startDate: 'Jan 23, 2019',
    location: '委内瑞拉全境',
    description: '委内瑞拉政治经济危机持续。马杜罗政府与反对派长期对峙，美国及西方制裁加剧经济崩溃，恶性通胀、医疗与基础设施崩溃。760万难民外逃，为全球最大难民危机之一。',
    keyDevelopments: ['马杜罗连任争议', '美国石油制裁加码', '760万难民外逃', '恶性通胀与基础设施崩溃', '反对派领导人流亡'],
  },
  {
    id: 'israel_homeland',
    name: '以色列多线战争',
    coords: [[35.5, 33.3], [35.9, 33.0], [35.5, 32.0], [35.4, 31.0], [35.0, 30.0], [34.2, 31.0], [34.5, 32.5], [35.0, 33.3], [35.5, 33.3]],
    center: [35, 31.5],
    intensity: 'high',
    parties: ['以色列', '哈马斯', '真主党', '伊朗', '胡塞武装'],
    casualties: '1200+ 以色列人遇难（10月7日袭击）',
    displaced: '以色列北部十余万人疏散',
    keywords: ['israel', 'tel aviv', 'jerusalem', 'hamas', 'hezbollah', 'iran', 'october 7', 'iron dome', 'lebanon'],
    startDate: 'Oct 7, 2023',
    location: '以色列本土（北部、南部边境及中部）',
    description: '以色列陷入多线战争：加沙地面行动持续，黎巴嫩真主党每日炮击北部边境致十余万人疏散，伊朗弹道导弹直接打击本土，胡塞武装间歇发射导弹。铁穹系统多次拦截，特拉维夫与耶路撒冷多次拉响警报。',
    keyDevelopments: ['10月7日哈马斯袭击造成1200+遇难', '真主党北部边境每日炮击', '伊朗弹道导弹直接打击以色列本土', '铁穹系统多次拦截', '北部十余万居民疏散'],
  },
  {
    id: 'usa_domestic',
    name: '美国国内安全危机',
    coords: [[-125, 49], [-95, 49], [-83, 46], [-67, 45], [-67, 25], [-80, 25], [-97, 26], [-117, 32], [-125, 40], [-125, 49]],
    center: [-98, 39],
    intensity: 'medium',
    parties: ['联邦政府', '各州政府', '政治极化团体'],
    casualties: '年均大规模枪击事件数百起',
    displaced: '国内社会撕裂',
    keywords: ['usa', 'united states', 'shooting', 'gun violence', 'polarization', 'protests', 'capitol', 'election', 'racism'],
    startDate: 'Jan 6, 2021',
    location: '美国本土',
    description: '美国深陷政治极化与社会撕裂。1月6日国会山事件标志政治暴力升级，枪支暴力与大规模枪击案频发，种族冲突与抗议活动此起彼伏，党派对立导致治理瘫痪。对外奉行霸权主义与单边制裁，是全球动荡的重要根源。',
    keyDevelopments: ['国会山事件标志政治暴力升级', '枪支暴力与大规模枪击案频发', '种族冲突与城市抗议持续', '政治极化导致治理瘫痪', '对外制裁与军事干预引发全球不满'],
  },
];
